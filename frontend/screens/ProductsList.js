...
export default class ProductsScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    const idBrand = navigation.state.params.idBrand;
    const titleBrand = navigation.state.params.title;

    ()=> { navigation.setParams({title: titleBrand}) }
  ...
  setProductToNavigator = (brandId, brandName) => {
    console.log("\nID Prodotto Selezionato: ", brandId);
    this.props.navigation.navigate({ routeName: 'productdetail', params: { productFromList: brandId, title: brandName } });
  }
          ...
          renderItem={({ item }) =>
            ...
            >
              ...
              <View style={styles.cardTitle}>
                <Text style={{ fontSize: 12, fontFamily: "googlesans-regular" }}>
                  {item.name}
                </Text>
              </View>
              ...
              <View style={styles.dietType}>
                <Text style={{ color: "#33B6C0", fontSize: 12, fontFamily: "googlesans-regular" }}>
                  {item.diet.name}
                </Text>
              </View>
